      ...
      <div className="max-w-xl mx-auto sticky top-4 z-10 bg-white border border-gray-300 rounded-xl shadow-xl p-6 mb-6">
        ...
        <div className="space-y-4">
          {tasks.map((task) => (
            <div
              key={task._id}
              className={`flex justify-between items-center p-4 border-l-4 rounded-lg shadow-sm transition ${
                task.completed ? "border-green-500 bg-green-50" : "border-yellow-400 bg-yellow-50"
              }`}
            >
              <div className="flex flex-col">
                <span
